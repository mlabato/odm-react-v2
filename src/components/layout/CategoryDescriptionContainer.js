...
const mappedCategories = categories.map(category => {
    return(
        <CategoryCard title={category.category} description={category.description} image={category.image} />
    )
})
...
const CategoryDescriptionContainer = () => {
  return (
    ...
    <article className="text-center font-bold text-[3rem]">Nuestros productos</article>
